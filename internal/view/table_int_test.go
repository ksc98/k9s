...
func (*mockTableModel) GetRefreshRate() time.Duration                       { return 0 }
func (*mockTableModel) GetLastRefreshAt() time.Time                         { return time.Time{} }
func (*mockTableModel) GetRefreshCount() int32                              { return 0 }
